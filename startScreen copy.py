...
class StartScreen:
    ...
    def showProfessionalQA(self):
        """Displays the searchable professional Q&A interface."""
        ...
        # Search Area
        searchBarFrame = tk.Frame(self.resultsContainer, bg="#DAA520", pady=20)
        searchBarFrame.pack(fill="x")
        ...
        # Scrollable Q&A List
        self.qnaCanvas = tk.Canvas(self.resultsContainer, bg="#DAA520", highlightthickness=0)
        self.qnaScrollBar = tk.Scrollbar(self.resultsContainer, orient="vertical", command=self.qnaCanvas.yview)
        ...
        self.qnaCanvas.pack(side="left", fill="both", expand=True, padx=50)
