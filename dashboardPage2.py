...
from settings import SettingsPage  # Ensure this file exists
...
class DashboardPage:
    def __init__(self, root, userEmail):
        ...
        # --- LOGO LOADING ---
        try:
            self.logoImg = tk.PhotoImage(file=r"C:\Users\dhanv\OneDrive\cs50\slc2026\logo.png").subsample(2, 2)
        except:
            self.logoImg = None 
    ...
    def create_settings_page(self):
        for widget in self.mainContainer.winfo_children():
            widget.destroy()
        settings_page = SettingsPage(self.mainContainer, self.colors, self)
        settings_page.draw()
    ...
    def create_single_row_header(self):
        ...
        # 2. Profile Icon (Right side) with dropdown
        self.profile_btn = tk.Menubutton(header, text="👤 Profile ✎", font=("Arial", 11),
                                         bg=self.colors['navBg'], relief="flat", cursor="hand2")
        ...
        profile_menu.add_command(label="Settings", command=lambda: self.navigateTo("Settings"))
    ...
    def edit_profile(self):
        messagebox.showinfo("Edit Profile", "This feature will allow profile editing (placeholder).")
